...
export const StatsCards: React.FC<StatsCardsProps> = ({ stats }) => {
    return (
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {/* Card 1 */}
            <Link href="/jobs" className="block transform transition-transform hover:-translate-y-1">
                <div className="bg-white rounded-2xl p-6 shadow-soft border border-gray-100 relative overflow-hidden group hover:shadow-medium transition-all duration-300 h-full">
                    <div className="absolute right-0 top-10 p-4 opacity-30 group-hover:opacity-10 transition-opacity transform group-hover:scale-110 duration-500">
                    ...
                    <div className="relative z-10">
                        ...
                        <p className="text-7xl mt-2  font-extrabold text-gray-600 tracking-tight">{stats.jobs}</p>
            ...
            {/* Card 2 */}
            <Link href="/applications" className="block transform transition-transform hover:-translate-y-1">
                <div className="bg-white rounded-2xl p-6 shadow-soft border border-gray-100 relative overflow-hidden group hover:shadow-medium transition-all duration-300 h-full">
                    <div className="absolute right-0 top-10 p-4 opacity-30 group-hover:opacity-10 transition-opacity transform group-hover:scale-110 duration-500">
                    ...
                    <div className="relative z-10">
                        ...
                        <p className="text-7xl mt-2 font-extrabold text-gray-600 tracking-tight">{stats.applicants}</p>
                        <div className="mt-4 flex items-center text-sm font-medium text-green-600 bg-green-50 px-2 py-1 rounded-md w-fit">
            ...
            <div className="bg-gradient-to-br from-primary-500 to-red-600 rounded-2xl p-6 shadow-lg shadow-orange-500/30 text-white relative overflow-hidden flex flex-col justify-between group hover:-translate-y-1 transition-transform">
                ...
                <Link href="/jobs" className=" bg-white text-primary font-bold py-3 px-4 rounded-xl text-center shadow-lg hover:bg-gray-50 transition-colors flex items-center justify-center gap-2">
